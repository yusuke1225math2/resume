...
- HTML・CSS(bootstrap)：9 年、JavaScript(jQuery)：4 年、React(Next.js):自主学習中
...
- 初めて触る FW や、AWS など、キャッチアップのハードルが高かったが、時間外の学習でカバー
...
SNS のアクション自動化・データ分析によりアカウント運用を
支援するシステムを 0 から企画・事業譲渡
　
#### 担当業務
